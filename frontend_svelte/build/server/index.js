import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './chunks/ssr-CTylFKGs.js';
...
import { w as writable, r as readable } from './chunks/index-Bt5_4Bzy.js';
import './chunks/utils-ByOLlbjM.js';
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n\n<html lang="en">\n	<head>\n    <!-- os arquivos css e js abaixo ficam na pasta /static, para que sejam copiados quando a aplicacao é transpilada (build) \n    se nao estiver na pasta /static, o node.js nao copia os arquivos para pasta /build -->\n    <link rel="stylesheet" type="text/css" href="css/spin.css" /> \n    <link rel="stylesheet" type="text/css" href="css/jquery-ui.min.css" /> \n    <script src="js/loadingGif.js" ><\/script>\n\n    <link rel="icon" href="data:,">  \n\n		<meta charset="utf-8" />\n\n<!--\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n-->\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		<div style="display: contents; ">' + body + "</div>\n	</body>\n\n</html>\n",
